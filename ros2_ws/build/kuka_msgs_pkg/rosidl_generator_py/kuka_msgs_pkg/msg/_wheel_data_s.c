...
bool kuka_msgs_pkg__msg__wheel_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("kuka_msgs_pkg.msg._wheel_data.WheelData", full_classname_dest, 39) == 0);
  }
  kuka_msgs_pkg__msg__WheelData * ros_message = _ros_message;
  {  // position
...
PyObject * kuka_msgs_pkg__msg__wheel_data__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("kuka_msgs_pkg.msg._wheel_data");
