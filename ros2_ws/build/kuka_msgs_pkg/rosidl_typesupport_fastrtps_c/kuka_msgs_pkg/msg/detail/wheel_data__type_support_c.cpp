...
#include "kuka_msgs_pkg/msg/detail/wheel_data__rosidl_typesupport_fastrtps_c.h"
...
using _WheelData__ros_msg_type = kuka_msgs_pkg__msg__WheelData;
...
size_t get_serialized_size_kuka_msgs_pkg__msg__WheelData(
  const void * untyped_ros_message,
...
static uint32_t _WheelData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_kuka_msgs_pkg__msg__WheelData(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_kuka_msgs_pkg
size_t max_serialized_size_kuka_msgs_pkg__msg__WheelData(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _WheelData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_kuka_msgs_pkg__msg__WheelData(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, kuka_msgs_pkg, msg, WheelData)() {
