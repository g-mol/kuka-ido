...
#include "kuka_msgs_pkg/msg/detail/wheel_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const kuka_msgs_pkg::msg::WheelData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<kuka_msgs_pkg::msg::WheelData *>(
    untyped_ros_message);
...
{
  return &kuka_msgs_pkg::msg::typesupport_fastrtps_cpp::_WheelData__handle;
}
